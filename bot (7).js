...
const developers = ["511509244315697152"]//Toxic Codes
client.on('message', message => {//Toxic Codes
  ...
  if (message.content.startsWith(adminprefix + '!')) {//Toxic Codes
  client.user.setPrefix(argresult).then
      message.channel.send(`Changing Prefix ..**${argresult}** `)//Toxic Codes
} else
if (message.content.startsWith(adminprefix + 'pho')) {//Toxic Codes
